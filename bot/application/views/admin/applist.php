						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
												<a href="/admin/app/edit/0" role="button" class="btn red" data-target="#ajax" data-toggle="modal">
														<i class="fa fa-pencil"></i> 添加一个指令
										</a>
