...
$config['chat_lng'] =array(
  ...
  'copyright_desc'=> '这是一款备受好评的大规模主机管理系统，你可以用它来管理来自全球的主机资源，可以支持多达数百万级的主机管理。支持多人协同管理、智能群集计划任务，同时你可以像操作本地WINDOWS一样操作主机资源。',
  'copyright_contact'=> '授权或定制请联系 <a href=\'javascript:core.openIE(\'http://www.bot.com\');\'>问题反馈</a>',
  'copyright_info'=> 'Copyright @ NetBot All rights reserved.',
  'copyright_pre'=> 'Powered by BotExplorer',
  'kod_name'=> 'BotExplorer',
  'kod_name_desc'=> '——暗云.资源管理器',
  'kod_power_by'=> ' - Powered by BotExplorer',
  'kod_name_copyright'=> '暗云.资源管理器',
  'login'=> '登陆 ',
  'guest_login'=> '游客登录',
  'username'=> '用户名',
  'password'=> '密码',
