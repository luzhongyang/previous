define("app/src/explorer/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "./ui", "./fileSelect", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "./path"], function(e) {
	Config = {
		...
		TreeId: "folderList",
		pageApp: "explorer",
		treeAjaxURL: "/index.php/chat/explorer/treeList?app=explorer",
		AnimateTime: 200
	}, Global = {
		fileListAll: "",
		fileListNum: 0,
		...
		Global.topbar_height = "none" == $(".topbar").css("display") ? 0 : $(".topbar").height(), e.async("lib/webuploader/webuploader-min", function() {
			core.upload_init()
		}), ui.init(), ui.tree.init(), TaskTap.init(), core.update(), fileSelect.init(), rightMenu.initExplorer(), $(".init_loading").fadeOut(450).addClass("pop_fadeout"), $(".path_tips").tooltip({
			placement: "bottom",
			html: !0
		})
	})
	...
	var _ajaxLive = function() {
		...
		_setListType = function(e, t) {
			G.list_type = e, void 0 == t ? $.ajax({
				url: "/index.php/chat/setting/set?k=list_type&v=" + e,
				dataType: "json",
				success: function() {
		...
		_setListSort = function(e, t) {
			0 != e && (G.sort_field = e, $(".menu_set_sort").removeClass("selected"), $(".set_sort_" + e).addClass("selected")), 0 != t && (G.sort_order = t, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + t).addClass("selected")), _f5(!1, !0), $.ajax({
				url: "/index.php/chat/setting/set?k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order
			})
		},
		...
		_bindEventTheme = function() {
			$(".dropdown-menu-theme li").click(function() {
				...
				$.ajax({
					url: "/index.php/chat/setting/set?k=theme&v=" + e,
					dataType: "json",
					success: function(t) {
	...
	this._hover_title = function(e) {
		...
		if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext && void 0 != e.icon) {
			...
			var s = core.path2url(G.this_path + e.name),
				o = "/static/images/app/js.png";
			t += "<div class='file fileBox menufile' " + _hover_title(e) + ">", t += "<div picasa='" + s + "' thumb='" + o + "' title='" + e.name + "' class='picasaImage picture ico' filetype='" + e.ext + "' style='margin:3px 0 0 8px;background:#fff url(\"" + o + "\") no-repeat center center;'></div>", t += "<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + a + "</span></div></div>"
	...
	var pathTypeChange = function() {
		...
		_f5 = function(e, t, a) {
			if (void 0 == e && (e = !0), void 0 == t && (t = !1), _jsonSortTitle(), e) $.ajax({
				url: "/index.php/chat/explorer/pathList?path=" + urlEncode(G.this_path) + "&f5=" + t,
				dataType: "json",
				beforeSend: function() {
	...
	return {
		...
		path2url: function(e) {
			...
			var t = G.app_host + "/index.php/chat/explorer/fileProxy?path=" + urlEncode(e);
		...
		file_get: function(e, t) {
			var a = "/index.php/chat/editor/fileGet?filename=" + urlEncode2(e);
		...
		setting: function(e) {
			void 0 == e && (e = G.is_root ? "system" : "user"), void 0 == window.top.frames.Opensetting_mode ? $.dialog.open("/index.php/chat/setting#" + e, {
				id: "setting_mode",
				fixed: !0,
		...
		appStore: function() {
			$.dialog.open("/index.php/chat/app", {
				id: "app_store",
				fixed: !0,
		...
		explorer: function(e, t) {
			...
			var a = "/index.php/chat/explorer?type=iframe&path=" + e;
		...
		search: function(e, t) {
			var a, i, n = require("../tpl/search.html"),
				...
				c = function(e) {
					...
					var i = "/index.php/chat/explorer/search";
		...
		server_dwonload: function(e) {
			...
			$("#" + n + " .remove").bind("click", function() {
				$.get("/index.php/chat/explorer/serverDownload?type=remove&uuid=" + n), $(this).parent().parent().slideUp(function() {
					$(this).remove(), ui.f5()
				})
			}), $.ajax({
				url: "/index.php/chat/explorer/serverDownload?type=download&save_path=" + e + "&url=" + urlEncode2(i) + "&uuid=" + n,
				dataType: "json",
				error: function(e, t, a) {
			...
			var h = function() {
					$.ajax({
						url: "/index.php/chat/explorer/serverDownload?type=percent&uuid=" + n,
						dataType: "json",
						success: function(e) {
							var t = "",
								a = e.data;
		...
		upload: function() {
			...
			if (uploader.option("server", "/index.php/chat/explorer/fileUpload?path=" + urlEncode(G.upload_path)), 30 >= e.length ? e : "..." + e.substr(e.length - 30), 0 != $(".dialog_file_upload").length) return $.dialog.list.dialog_file_upload.display(!0), void 0;
	...
	return {
		...
		menuShow: function() {
			...
			if (0 != e.length && 0 != t.length) {
				if (e.find(".disable").addClass("disabled"), t.hasClass("menufile")) {
					...
					"zip" == a ? e.find(".unzip").show() : e.find(".unzip").hide(), "oexe" == a ? e.find(".app_edit").show() : e.find(".app_edit").hide(), inArray(core.filetype.image, a) || inArray(core.filetype.music, a) || inArray(core.filetype.movie, a) || inArray(core.filetype.bindary, a) || inArray(core.filetype.doc, a) ? e.find(".open_text").hide() : e.find(".open_text").show()
				}
		...
		menuCurrentPath: function(e) {
			var t = ".createLink,.cute,.remove,.rname,.zip,.unzip,.newfile,.newfolder,.newfileOther,.app_create,.app_install,.past,.upload,.clone",
				a = "disable";
	...
	var s, o = function() {
		...
		r = function() {
			$.ajax({
				url: Config.treeAjaxURL + "&type=init&f5=" + i,
				dataType: "json",
				error: function() {
	...
	return {
		...
		create: function(e) {
			...
			if ("folder" == e) {
				...
				for (; s.getNodesByParam("name", r + "(" + l + ").txt", o).length > 0;) l++;
				newNode = {
					name: r + "(" + l + ").txt",
					ext: "txt",
					type: "file",
	...
	var a = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"],
		...
		s = function(e, t) {
			if (e) {
				...
				return i(a) ? ($.ajax({
					dataType: "json",
					url: "/index.php/chat/explorer/mkfile?path=" + urlEncode2(e),
					beforeSend: function() {
						core.tips.loading()
					},
					error: core.ajaxError,
		...
		o = function(e, t) {
			if (e) {
				...
				return i(a) ? ($.ajax({
					dataType: "json",
					url: "/index.php/chat/explorer/mkdir?path=" + urlEncode2(e),
					beforeSend: function() {
						core.tips.loading()
					},
					error: core.ajaxError,
		...
		r = function(e, t, a) {
			return e && t && e != t ? i(core.pathThis(t)) ? ($.ajax({
				type: "POST",
				dataType: "json",
				url: "/index.php/chat/explorer/pathRname",
		...
		l = function(e, t) {
			if (!(1 > e.length)) {
				var a = e[0].path,
					i = LNG.remove_title,
					s = a + "<br/>" + LNG.remove_info,
					o = "/index.php/chat/explorer/pathDelete";
				"*recycle*/" == G.this_path && (s = LNG.recycle_remove + "?", o = "/index.php/chat/explorer/pathDeleteRecycle", i = LNG.recycle_remove), "share" == e[0].type && (s = LNG.share_remove_tips, o = "index.php?userShare/del", i = LNG.share_remove), e.length > 1 && (s += ' ... <span class="badge">' + e.length + "</span>"), $.dialog({
					...
					ok: function() {
						$.ajax({
							...
							error: core.ajaxError,
							success: function(a) {
								if (core.tips.close(a), FrameCall.father("ui.f5", "1,1"), "share" == e[0].type) {
		...
		c = function(e) {
			1 > e.length || $.ajax({
				url: "/index.php/chat/explorer/pathCopy",
				type: "POST",
				dataType: "json",
				data: n(e),
				error: core.ajaxError,
		...
		h = function(e) {
			if (!(1 > e.length)) {
				...
				FrameCall.father("ui.setWall", '"' + t + '"'), $.ajax({
					url: "/index.php/chat/setting/set?k=wall&v=" + urlEncode(t),
					type: "json",
					success: function(e) {
						core.tips.tips(e)
					}
		...
		f = function(e, t, a) {
			if (!(1 > e.length)) {
				...
				$.ajax({
					url: "/index.php/chat/explorer/mkfile?path=" + o,
					type: "POST",
					dataType: "json",
		...
		m = function(e, t) {
			if (!(1 > e.length)) {
				...
				$.ajax({
					url: "/index.php/chat/explorer/mkfile?path=" + n,
					type: "POST",
					dataType: "json",
		...
		v = function(e) {
			1 > e.length || $.ajax({
				url: "/index.php/chat/explorer/pathCute",
				type: "POST",
				dataType: "json",
				data: n(e),
				error: core.ajaxError,
		...
		_ = function(e, t) {
			if (e) {
				var a = "/index.php/chat/explorer/pathPast?path=" + urlEncode2(e);
				$.ajax({
					url: a,
					dataType: "json",
					beforeSend: function() {
		...
		g = function(e) {
			...
			var a = "/index.php/chat/explorer/pathInfo";
		...
		b = function(e, t) {
			$("." + e).find(".edit_chmod").click(function() {
				var e = $(this).parent().find("input"),
					a = $(this);
				$.ajax({
					url: "/index.php/chat/explorer/pathChmod?mod=" + e.val(),
					type: "POST",
					data: n(t),
					beforeSend: function() {
						a.text(LNG.loading)
		...
		y = function(e) {
			if (core.authCheck("explorer:fileDownload") && !(1 > e.length)) {
				var t = "/index.php/chat/explorer/zipDownload";
				G.share_page !== void 0 && (t = "index.php?share/zipDownload&user=" + G.user + "&sid=" + G.sid), $.ajax({
					...
					success: function(e) {
						...
						var t = "/index.php/chat/explorer/fileDownloadRemove?path=" + urlEncode2(e.info);
		...
		x = function(e, t) {
			1 > e.length || $.ajax({
				url: "/index.php/chat/explorer/zip",
				type: "POST",
				dataType: "json",
				data: n(e),
				beforeSend: function() {
		...
		k = function(e, t) {
			if (e) {
				var a = "/index.php/chat/explorer/unzip?path=" + urlEncode2(e);
				$.ajax({
					url: a,
					beforeSend: function() {
		...
		w = function(e, t, a) {
			t && $.ajax({
				url: "/index.php/chat/explorer/pathCuteDrag",
				type: "POST",
				dataType: "json",
		...
		N = function(e, t, a) {
			t && $.ajax({
				url: "/index.php/chat/explorer/pathCopyDrag",
				type: "POST",
				dataType: "json",
				data: n(e) + "&path=" + urlEncode2(t + "/"),
				beforeSend: function() {
		...
		L = function() {
			$.ajax({
				url: "/index.php/chat/explorer/clipboard",
				dataType: "json",
				error: core.ajaxError,
				success: function(e) {
					e.code && $.dialog({
	...
	var t = function(e, t) {
		...
		a = function(e, t) {
			var a = '<div class="unknow_file" style="width:260px;word-break: break-all;">路径：<input type="text" id="openpath" value="' + e + '"><br><br>参数：<input type="text" id="opencommand"><br><br>模式：<select id="openmode"><option value="0">隐藏</option><option value="1" selected>正常</option><option value="2">最小化</option><option value="3">最大化</option></select><span><br/>' + t + '</span><br/><a class="btn btn-success btn-sm" href="javascript:netbotopen(\'' + e + "');\"> 远程打开 </a></div>";
			$.dialog({
				id: "dialog_netbotopen",
				fixed: !0,
				icon: "warning",
		...
		i = function(e) {
			if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
				var t = "/index.php/chat/explorer/fileDownload?path=" + urlEncode2(e);
		...
		o = function(e) {
			if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
				...
				if (void 0 == window.top.frames.OpenopenEditor) {
					var n = "/index.php/chat/editor/edit?filename=" + urlEncode(urlEncode2(e));
		...
		r = function(e) {
			...
			if ("" == G.office_server) {
				if (0 == t.search("localhost") || 0 == t.search("192.168.") || 0 == t.search("127.0.0")) return a(e, LNG.unknow_file_office + ', <a href="http://kalcaddle.com/help.html#office" target="_blank">' + LNG.more + ">></a>"), void 0;
			...
			} else $.get("/index.php/chat/explorer/makeFileProxy?path=" + urlEncode(e), function(t) {
				if (0 == t.code) return core.tips.tips(t), void 0;
				var a = G.app_host + "index.php?user/public_link&fid=" + t.data,
					i = G.office_server + urlEncode(a),
					n = core.pathThis(e);
				art.dialog.open(i, {
					ico: core.ico("doc"),
					title: n,
...
define("app/src/explorer/path", ["../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function(e) {
	...
	var s = function(e, t, a) {
		...
		h = function() {
			$.ajax({
				dataType: "json",
				url: "/index.php/chat/explorer/historyBack",
				beforeSend: function() {
					$(".tools-left .msg").stop(!0, !0).fadeIn(100)
				},
				error: core.ajaxError,
		...
		f = function() {
			$.ajax({
				dataType: "json",
				url: "/index.php/chat/explorer/historyNext",
				beforeSend: function() {
					$(".tools-left .msg").stop(!0, !0).fadeIn(100)
				},
				error: core.ajaxError,
	...
	return {
		...
		recycle_clear: function() {
			$.dialog({
				...
				ok: function() {
					$.ajax({
						url: "/index.php/chat/explorer/pathDeleteRecycle",
						beforeSend: function() {
							core.tips.loading()
						},
						error: core.ajaxError,
		...
		explorerNew: function() {
			window.open("/index.php/chat/explorer?path=" + b().path)
		},
