...
jQuery.fn.timelinr = function(options){
	...
	settings = jQuery.extend({
		...
		containerDiv: 				'#fx_time_timeline',		// value: any HTML tag or #id, default to #timeline
		datesDiv: 					'#fx_time_dates',			// value: any HTML tag or #id, default to #dates
		datesSelectedClass: 		'selected',			// value: any class, default to selected
		datesSpeed: 				500,				// value: integer between 100 and 1000 (recommended), default to 500 (normal)
		issuesDiv: 					'#fx_time_issues',			// value: any HTML tag or #id, default to #issues
		...
		prevButton: 				'#fx_time_prev',			// value: any HTML tag or #id, default to #prev
		nextButton: 				'#fx_time_next',			// value: any HTML tag or #id, default to #next
	...
	$(function(){
		...
		$(settings.datesDiv+' li').eq(settings.startAt+3).find('a').trigger('click');
