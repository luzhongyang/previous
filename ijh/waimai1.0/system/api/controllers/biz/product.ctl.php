...
class Ctl_Biz_Product extends Ctl_Biz
{
    ...
    public function items($params)
    {
        ...
        $count = K::M('product/product')->count(array('shop_id'=>$this->shop_id, 'closed'=>0));
    ...
    public function update($params)
    {
        ...
        }else if(!$data = $this->check_fields($params, 'title,photo,cate_id,price,package_price,sales,sale_type,sale_sku,sale_count,intro,orderby')){
