       ...
       header("Location:" . U('mobile/passport/login'));die;
        ...
        if(is_android()){
             echo  '<script type="text/javascript" language="javascript"> window.jsObj.goLogin();</script>';die;
              ...
              echo  '<script type="text/javascript" language="javascript"> setTimeout(function(){goload();},1000)</script>';die;
        }
        
    }
}

function AppPay($order_id=0,$amount=0,$url='',$type){
    if(is_app()){
        if(is_android()){
             echo  '<script type="text/javascript" language="javascript"> setTimeout(function(){window.jsObj.go_pay('.$order_id.','.$amount.','.$url.',"'.$type.'"'.');},1000)</script>';die;
        }else{
              echo  '<script type="text/javascript" language="javascript"> setTimeout(function(){go_pay('.$order_id.','.$amount.',"'.$url.'"'.',"'.$type.'"'.');},1000)</script>';die;
        }
    }
}
...
function baolog($fname,$log)
{
	...
	$fp = @fopen(APP_PATH.'Runtime/Logs/'."{$fname}.php","a");
	@fwrite($fp,$log);
	@fclose($fp);
}