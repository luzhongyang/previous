...
class Wxmesg{
	...
	//订单支付成功(团购券)
	static public function pay_success($data=null)
	{
		...
		return array(
			...
			'data'		   => array(
				'first'   =>array('value'=>$data['first'],   'color'=>'#000000'),
				'keyword1'=>array('value'=>$data['order_id'],   'color'=>'#000000'), //订单编号
				'keyword2'=>array('value'=>$data['need_pay'],'color'=>'#000000'), //支付金额
				'keyword3'=>array('value'=>$data['title'],    'color'=>'#000000'), //商品名称
				'keyword4'=>array('value'=>$data['code'],'color'=>'#000000'), //电子兑换码
				'remark'  =>array('value'=>$data['remark'],  'color'=>'#000000')
			)
		);
	}
