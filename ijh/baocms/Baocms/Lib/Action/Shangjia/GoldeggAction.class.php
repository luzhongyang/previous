...
class GoldeggAction extends CommonAction {
    private $create_fields = array('id','predict_num','shop_id','keyword_id','keyword','photo','title','use_tips','stime','ltime','info','aginfo','end_tips','end_photo','fist','fistnums','fistlucknums','second','secondnums','secondlucknums','third','thirdnums','thirdlucknums','oinnum','max_num','parssword','four','fournums','fourlucknums','five','fivenums','fivelucknums','six','sixnums','sixlucknums','daynums','member_condtion','dateline','follower_condtion');
	...
	public function create()
	{
            ...
            if ($this->isPost()) {
                ...
                if ($id = $obj->add($data)) {
                    $url = U('weixin/goldegg/show', array('goldegg_id' => $id));
                    $url = __HOST__ . $url;
