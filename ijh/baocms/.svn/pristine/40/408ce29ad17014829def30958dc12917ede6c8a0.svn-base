...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title', 'shop_id', 'photo', 'cate_id', 'price', 'mall_price','settlement_price','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','ltme','rush_ltime','rush_kucun','rush_price','max_buy','attr');
    private $edit_fields = array('title', 'shop_id', 'photo', 'cate_id', 'price', 'mall_price','settlement_price','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','ltme','rush_ltime','rush_kucun','rush_price','max_buy','attr');
    ...
    private function createCheck() {
        ...
        $data['rush_kucun'] = (int) $data['rush_kucun']; 
