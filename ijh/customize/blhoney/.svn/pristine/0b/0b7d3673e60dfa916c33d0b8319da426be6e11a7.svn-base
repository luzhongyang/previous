...
{   
    ...
    protected $_cols = 'product_id,shop_id,cate_id,title,photo,price,package_price,sales,sale_type,sale_sku,sale_count,intro,orderby,closed,clientip,dateline,is_spec';
