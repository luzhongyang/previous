<?php /* Smarty version Smarty-3.1.8, created on 2016-08-16 11:36:55
         compiled from "admin:shop/shop/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:174549903557b28a574ea8d3-26274427%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '174549903557b28a574ea8d3-26274427',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b28a575fb691_27126201',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b28a575fb691_27126201')) {function content_57b28a575fb691_27126201($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include '/data/htdocs/blhoney_com/public_html/system/plugins/smarty/function.link.php';
...
" class="input w-200"/><span class="tip-comment">手机号，登录用</span></td></tr>
        <tr><th><span class="red">*</span>密码：</th><td><input type="password" name="data[passwd]" value="******" class="input w-200"/></td></tr>
        <tr>
            <th><span class="red">*</span>客服电话：</th>
            <td>
...
"<?php }?> class="input w-300" />&nbsp;&nbsp;&nbsp;<input type="file" name="data[logo]" class="input w-100" /></td></tr>
        ...
        <tr><th><span class="red">*</span>banner：</th><td><input type="text" name="data[banner]" value="<?php echo $_smarty_tpl->tpl_vars['detail']->value['banner'];?>
...
" id="Bmap_marker_lat" class="input w-100"/></label>    
        ...
        <tr><th><span class="red">*</span>地址：</th><td><input type="text" name="data[addr]" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['detail']->value['addr'])===null||$tmp==='' ? '' : $tmp);?>
" class="input w-500"/></td></tr>
        <tr><th><span class="red">*</span>首单优惠：</th><td><input type="text" name="data[first_amount]" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['detail']->value['first_amount'])===null||$tmp==='' ? '0.00' : $tmp);?>
" class="input w-100"/><span class="tip-comment">首单优惠</span></td></tr>
        <tr><th><span class="red">*</span>起送价：</th><td><input type="text" name="data[min_amount]" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['detail']->value['min_amount'])===null||$tmp==='' ? '0.00' : $tmp);?>
" class="input w-100"/><span class="tip-comment">起送</span></td></tr>
        <tr><th><span class="red">*</span>开始营业时间：</th><td><input type="text" name="data[yy_stime]" value="<?php echo $_smarty_tpl->tpl_vars['detail']->value['yy_stime'];?>
" class="input w-100"/><span class="tip-comment">开始营业时间</span></td></tr>
        <tr><th><span class="red">*</span>打烊时间：</th><td><input type="text" name="data[yy_ltime]" value="<?php echo $_smarty_tpl->tpl_vars['detail']->value['yy_ltime'];?>
" class="input w-100"/><span class="tip-comment">打烊时间</span></td></tr>
