...
class __CFG
{
    ...
    CONST MYSQL = 'mysql://dz_blhoney:qep6sUduzKyUQcW5@localhost:3306/dz_blhoney/jh_/UTF8';

    CONST SECRET_KEY = '5e1f4fbc96d97e73aeebee5b2609bfa7';
    CONST Authorize = 'f67326b64588028693bf3d0c08c1eec4';

    //Cookie
    CONST C_PREFIX  = 'KT-';
    CONST C_PATH    = '/';
    CONST C_DOMAIN  = '.blhoney.com';
