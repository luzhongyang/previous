...
class Ctl_Biz_Comment extends Ctl_Biz
{
    ...
    protected $_allow_fields = 'comment_id,shop_id,uid,order_id,score,score_fuwu,score_price,content,have_photo,reply,reply_time,dateline,mobile,face,photo';
    ...
    public function items($params)
    {
        ...
        $total_comment = K::M('shop/comment')->count(array('shop_id'=>$this->shop_id,'comment_status'=>1));
        $this->msgbox->set_data('data', array('items'=>array_values($items), 'total_count'=>$total_comment));
    }
