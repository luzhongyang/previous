...
{   
    ...
    protected $_cols = 'log_id,uid,from,payment,trade_no,order_id,amount,payed,payedip,payedtime,pay_trade_no,extra_pay,clientip,dateline';
    ...
    public function log_by_order_id($order_id, $kind=null)
    {
        if(!is_numeric($order_id)){
            return false;
        }
        $sql = "SELECT * FROM ".$this->table($this->_table)." WHERE order_id=$order_id AND from=$kind ORDER BY log_id";
