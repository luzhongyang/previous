...
//         createUserNav(2, 0);
//     };
//     function createUserNav(msg_type, num) {
//         var str_havel='';
//         msg_type    = msg_type  || 1;
//         num         = num       || 0;
...
// 			});  
// 			str_havel+=message;
// 			jq('#nav_user_data').html(str_havel);
//             jq('.header_top_right > ul > li div.htr_username').bind("mouseenter", function(){
//                     jq(this).find('div.user_memu').show();
//             });
//             jq('.header_top_right > ul > li div.htr_username > div.user_memu').bind("mouseleave", function(){
//                     jq(this).hide();
//             });
//         //}
//     };
...
var weChatQrcode = {
    ...
    createQrcodeTmp: function() {
        ...
        var qrcodeTmp = '<div class="wechat_barcode" id="wechat_barcode">\
                            <div class="we_inwrap">\
                            <a href="http://www.to8to.com/apps/index.php?act=apps_wechat">\
