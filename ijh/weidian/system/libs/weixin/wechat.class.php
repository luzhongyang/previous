...
{   
    ...
    private function _replyData($msg, $msgType)
    {
        ...
        if($this->Crypt){
            ...
            if($errCode){
                $line = "File:".__FILE__.", Line:".__LINE__; K::M('system/logs')->log('weixin.api.line', array($line));
                return false;
            }
            $line = "File:".__FILE__.", Line:".__LINE__; K::M('system/logs')->log('weixin.api.line', array($line, $keywordArr));
            $xmldata = $content;
        }
        $line = "File:".__FILE__.", Line:".__LINE__; K::M('system/logs')->log('weixin.api.line', array($line, $keywordArr));
        echo ($xmldata);
