...
class Mdl_Payment_Log extends Mdl_Table
{
    ...
    protected $_cols    = 'log_id,uid,from,payment,trade_no,order_id,amount,payed,payedip,payedtime,pay_trade_no,extra_pay,clientip,dateline,pay_level';
    ...
    public function log_by_order_id($order_id, $level, $from = 'order')
    {
