...
class Mdl_Weidian_Product extends Mdl_Table
{
    ...
    protected $_cols = 'product_id,shop_id,cate_id,title,type,photo,price,wei_price,price_level_1,price_level_2,price_level_3,intro,sales,stock,is_onsale,closed,dateline,clientip,orderby,ship_fee,is_fenxiao,price_type,delivery_type,delivery_price,delivery_tpl_id';
    ...
    {
        $table1 =  $this->table('weidian_product');
