...
{   
    ...
    protected $_cols = 'hongbao_id,from,title,min_amount,amount,type,uid,hongbao_sn,stime,ltime,order_id,used_ip,used_time,clientip,dateline';
    ...
    {
        $hongbao = $this->find(array('uid'=>$uid, 'from'=>$from, 'min_amount'=>'<=:'.$amount,'ltime'=>'>=:'.__TIME,'order_id'=>0),array('amount'=>'desc'));
