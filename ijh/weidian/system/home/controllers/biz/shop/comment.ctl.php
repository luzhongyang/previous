...
class Ctl_Biz_Shop_Comment extends Ctl_Biz 
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'biz/shop/comment/index.html';
    }
    ...
    public function detail($comment_id)
    {
        if(!$comment_id = (int)$comment_id){
            ...
            //print_r($photos);die;
            $this->tmpl = 'biz/shop/comment/detail.html';
        }
    }
    ...
    public function reply($comment_id=0)
    {
       if(!($comment_id = (int)$comment_id) && !($comment_id = $this->GP('comment_id'))){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'biz/shop/comment/reply.html';
        }   
    }
