...
class Ctl_Biz_Shop_Print extends Ctl_Biz
{
    public function index($page)
    {
        ...
        $this->tmpl = 'biz/shop/print/index.html';
    }
    ...
    public function create()
    {
        if($data = $this->checksubmit('data')){
            ...
            if($plat_id = K::M('shop/print')->create($data)){
                ...
                $this->msgbox->set_data('forward',  $this->mklink('biz/shop/print:index'));
            } 
        }else{
            $this->tmpl = 'biz/shop/print/create.html';
        }
    }
    ...
    public function edit($plat_id=null)
    {
        if(!$plat_id = (int)$plat_id){
            ...
            $this->tmpl = 'biz/shop/print/edit.html';
        }
    }
