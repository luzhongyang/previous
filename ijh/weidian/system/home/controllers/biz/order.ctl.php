...
class Ctl_Biz_order extends Ctl_Biz
{
    ...
    public function porder($order_id){
       $order_id = (int)$order_id;
        if(!$order_id) {
           ...
           $this->tmpl = 'biz/order/waimai/porder.html';
        }
    }
    ...
    public function pei($page=1)
    {
        ...
        $this->tmpl = 'biz/order/waimai/pei.html';
    }
    ...
    public function complete($page=1) 
    {
        ...
        $this->pagedata['staffs'] = K::M('staff/staff')->items_by_ids($staff_ids);
        $this->tmpl = 'biz/order/waimai/complete.html';
    }
    ...
    public function cancellist($page=1) 
    {
        ...
        $this->pagedata['staffs'] = K::M('staff/staff')->items_by_ids($staff_ids);
        $this->tmpl = 'biz/order/waimai/cancellist.html';
    }
    ...
    public function delivered($page=1) 
    {
        ...
        $this->pagedata['staffs'] = K::M('staff/staff')->items_by_ids($staff_ids);
        $this->tmpl = 'biz/order/waimai/delivered.html';
    }
    ...
    public function waimai()
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/order/waimai/index.html';
    }
    ...
    public function t_index($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->tmpl = 'biz/order/tuan/index.html';
    }
    public function t_history()
    {
        $this->tmpl = 'biz/order/tuan/history.html';
    }
    public function t_manager($page=1)
    {
        ...
        $this->tmpl = 'biz/order/tuan/manager.html';
    }
    public function t_quan()
    {
        $this->tmpl = 'biz/order/tuan/quan.html';
    }
    ...
    public function maidan($page=1)
    {
        ...
        $this->tmpl = 'biz/order/maidan/index.html';
    }
    ...
    public function detailorder($order_id) 
    {
        ...
        $this->tmpl = 'biz/order/detailorder.html';
    }
    ...
    public function detailcomment($order_id) 
    {
        ...
        if($order_id != (int)$order_id) {
            ...
            $this->tmpl = 'biz/order/detailcomment.html';
        }
    ...
    public function detailcomplain($order_id) 
    {
        ...
        $this->tmpl = 'biz/order/detailcomplain.html';
    }
    ...
    public function detailsystem($order_id) 
    {
        ...
        $this->tmpl = 'biz/order/detailsystem.html';
    }
