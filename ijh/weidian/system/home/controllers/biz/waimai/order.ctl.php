...
class Ctl_Biz_Waimai_Order extends Ctl_Biz_Waimai
{
    ...
    public function waimai($page)
    {
        ...
        $this->tmpl = 'biz/waimai/order/index.html';
    }
    ...
    public function porder($order_id)
    {
       $order_id = (int)$order_id;
        if(!$order_id) {
           ...
           $this->tmpl = 'biz/waimai/order/porder.html';
        }
    }
    ...
    public function pei($page=1)
    {
        ...
        $this->tmpl = 'biz/waimai/order/pei.html';
    }
    ...
    public function cancellist($page=1) 
    {
        ...
        $this->pagedata['staffs'] = K::M('staff/staff')->items_by_ids($staff_ids);
        $this->tmpl = 'biz/waimai/order/cancellist.html';
    }
    ...
    public function ziti($page)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/waimai/order/ziti.html';
    }
    ...
    public function dialog($order_id)
    {
        ...
        $this->tmpl = 'biz/waimai/order/dialog.html';   
    }
    ...
    public function detail($order_id)
    {
        if(!$order_id = (int)$order_id){
            ...
            $this->pagedata['detail'] = $order;
            $this->tmpl = 'biz/waimai/order/detail.html';
        }
    }
}