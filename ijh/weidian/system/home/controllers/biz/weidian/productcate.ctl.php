...
class Ctl_Biz_Weidian_Productcate extends Ctl_Biz_Weidian
{
    ...
    public function index($page)
    {
        ...
        $this->tmpl = 'biz/weidian/productcate/index.html';
    }
    ...
    public function create()
    {
        if($data = $this->checksubmit('data')){
            ...
            if($cate_id = K::M('weidian/productcate')->create($data)){
                ...
                $this->msgbox->set_data('forward', '?biz/weidian/productcate-index.html');
            } 
        }else{
            $this->pagedata['cate_tree'] = K::M('weidian/productcate')->tree($this->shop_id);
            $this->tmpl = 'biz/weidian/productcate/create.html';
        }
    }
    ...
    public function edit($cate_id=null)
    {
        if(!($cate_id = (int)$cate_id) && !($cate_id = $this->GP('cate_id'))){
            ...
            $this->tmpl = 'biz/weidian/productcate/edit.html';
        }
    }
