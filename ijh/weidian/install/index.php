...
class Index extends Kernel
{
    ...
    public function install()
    {
        ...
        //pintuan
		    if(file_exists(__APP_DIR.'data/jh_pintuan.php')){
			     $sql .= file_get_contents(__APP_DIR.'data/jh_pintuan.php')."\n";
		    }
        if(file_exists(__APP_DIR.'data/jh_fenxiao.php')){
			     $sql .= file_get_contents(__APP_DIR.'data/jh_fenxiao.php')."\n";
		    }
