...
class Ctl_waimai_ordermanage extends Ctl_Waimai
{
    ...
    public function index($page=1) //0:全部，1：待接订单，2：待配送订单，3：待完成订单，4：已完成订单
    {
      ...
      // echo '<pre>';print_r($items);die;
       //echo '<pre>'; print_r($this->system->db->SQLLOG());die;
        ...
        $this->tmpl = 'merchant:waimai/order/manage.html';
    }
    ...
    public function pei($page=1)
    {
       $filter = $pager =  array();
        ...
        $this->tmpl = 'merchant:order/pei.html';
    }
    ...
    public function detail($order_id) 
    {
    	...
    	$this->tmpl = 'merchant:order/detail.html';
    }
