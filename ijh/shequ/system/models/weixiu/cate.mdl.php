...
class Mdl_Weixiu_Cate extends Mdl_Table
{   
  
    protected $_table = 'weixiu_cate';
    protected $_pk = 'cate_id';
    protected $_cols = 'cate_id,parent_id,title,icon,photo,price,orders,info,orderby,dateline,start';
    protected $_pre_cache_key = 'weixiu-cate-list';
