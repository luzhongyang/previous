...
class Ctl_Biz_Weidian_Pintuanorder extends Ctl_Biz_Weidian
{
    ...
    public function index($page)
    {
        ...
        $count = K::M('weidian/pintuan/order')->pintuan_order_count($filter);

        if($items = K::M('weidian/pintuan/order')->pintuan_order_list($filter, $page, $limit)){
            $pager['count'] = $count;
        ...
        $this->tmpl = 'biz/weidian/pintuanorder/index.html';
    }
