...
class Ctl_Biz_Weidian_Order extends Ctl_Biz_Weidian
{
    ...
    public function weidian($page,$fenxiao)
    {
        ...
        $this->tmpl = 'biz/weidian/order/index.html';
    }
    ...
    public function porder($order_id)
    {
       $order_id = (int)$order_id;
        if(!$order_id) {
           ...
           $this->tmpl = 'biz/weidian/order/porder.html';
        }
    }
    ...
    public function fahuo($page=1,$fenxiao)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/weidian/order/fahuo.html';
    }
    ...
    public function shouhuo($page=1,$fenxiao)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/weidian/order/shouhuo.html';
    }
    ...
    public function cancel($order_id=null)
    {
        if($order_id = (int)$order_id){
            ...
            }else if(K::M('weidian/order')->cancel($order_id,$order,'shop')){
            ...
            if($ids){
                foreach($ids as $k=>$val){
                     K::M('weidian/order')->cancel($val,null,'shop');
                }
    ...
    public function complete($page=1,$fenxiao,$day=null) 
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/weidian/order/complete.html';
    }
    ...
    public function cancellist($page=1,$fenxiao) 
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/weidian/order/cancellist.html';
    }
    ...
    public function confirm($page=1,$fenxiao)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/weidian/order/confirm.html';
    }
    ...
    public function ziti($page,$fenxiao)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/weidian/order/ziti.html';
    }
    ...
    public function dialog($order_id)
    {
        ...
        $this->tmpl = 'biz/weidian/order/dialog.html';   
    }
    ...
    public function setspend()
    {
        if($data = $this->checksubmit('data')) {
            if(!$data = $this->check_fields($data, 'order_id,spend_number')){
                ...
                if(K::M('weidian/order')->complete($data['order_id'],$weidian_order)) {
                    //print_r($this->system->db->SQLLOG());die;
    ...
    public function detail($order_id)
    {
        if(!$order_id = (int)$order_id){
            ...
            $this->pagedata['detail'] = $order;
            $this->tmpl = 'biz/weidian/order/detail.html';
        }
    }
