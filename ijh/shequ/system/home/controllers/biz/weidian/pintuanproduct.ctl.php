...
class Ctl_Biz_Weidian_Pintuanproduct extends Ctl_Biz_Weidian
{
    ...
    public function index($page)
    {
        ...
        $this->tmpl = 'biz/weidian/pintuanproduct/index.html';
    }
    ...
    public function create()
    {
        if($data = $this->checksubmit('data')){
            ...
            if($product_id = K::M('weidian/product')->create($data)){  //先插入product表，再处理pintuanproduct表
                ...
                $this->msgbox->set_data('forward', '?weidian/pintuan/product-index.html');
            }
        }
        else{
            $detail = array();
            ...
            $this->tmpl = 'biz/weidian/pintuanproduct/create.html';
        }
    }
...
//        $error .= 'test error';
    ...
    public function edit($product_id = null)
    {
        if(!($product_id = (int) $product_id) && !($product_id = $this->GP('product_id'))){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'biz/weidian/pintuanproduct/edit.html';
        }
    }
