...
class Ctl_Biz_Yuyue_Order extends Ctl_Biz
{
	// 排号订单待接单列表
	public function paidui($page=1)
	{
		...
		$this->tmpl = 'biz/yuyue/order/paidui_items.html';
	}
    ...
    public function paidui_wait_items($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/yuyue/order/paidui_wait_items.html';
    }
    ...
    public function paidui_complete_items($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/yuyue/order/paidui_complete_items.html';
    }
    ...
    public function paidui_cancel_items($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/yuyue/order/paidui_cancel_items.html';
    }
	...
	public function paidui_choose_zhuohao($paidui_id)
	{
        ...
        $this->tmpl = 'biz/yuyue/order/paidui_choose_zhuohao_dialog.html';
	}
	...
	public function dingzuo($page=1)
	{
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
		$this->tmpl = 'biz/yuyue/order/dingzuo_items.html';
	}
    ...
    public function dingzuo_wait_items($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/yuyue/order/dingzuo_wait_items.html';
    }
    ...
    public function dingzuo_complete_items($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'biz/yuyue/order/dingzuo_complete_items.html';
    }
    ...
    public function dingzuo_cancel_items($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->tmpl = 'biz/yuyue/order/dingzuo_cancel_items.html';
    }
    ...
    public function dingzuo_choose_zhuohao($dingzuo_id)
    {
        ...
        $this->tmpl = 'biz/yuyue/order/dingzuo_choose_zhuohao_dialog.html';
    }
