...
class Ctl_Biz_Waimai_Shop extends Ctl_Biz_Waimai
{
   ...
   public function pei()
   {
        if($data = $this->checksubmit('data')){
            if(!$data = $this->check_fields($data,'min_amount,freight,pei_distance,pei_type,pei_amount,fkm,fm,sm')){
                ...
                $data['pei_distance'] = round($data['pei_distance'])>0?round($data['pei_distance']):3;
            ...
            $this->tmpl = 'biz/waimai/shop/pei.html';
        }
    }
        ...
        if($data = $this->checksubmit('data')){
            ...
            if(!$waimai){ // 新建
                ...
                if($add = K::M('waimai/waimai')->create($data)){
                    ...
                    $this->msgbox->set_data('forward',  $this->mklink('biz/waimai/shop/have.html'));
                }else{
            ...
            $this->tmpl = 'biz/waimai/shop/have.html';
     ...
     public function youhui()
    {
        ...
        if($data = $this->checksubmit()){
            ...
            $this->tmpl = 'biz/waimai/shop/youhui.html';
        }
    }
