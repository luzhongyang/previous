...
class Ctl_Biz_Weixin_Index extends Ctl_Biz_Weixin
{
    
    public function index()
    {
        $this->tmpl = 'biz/weixin/index.html';
    }
    
    
    public function bind()
    {
        $this->tmpl = 'biz/weixin/bind.html';
    }

    public function wxloginpage()
    {
        $component = K::M('weixin/wechat')->component_client();
        $redirect_url = $this->mklink('biz/weixin/index/wxcallback', null, null, 'www');
    ...
    public function welcome()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'biz/weixin/welcome.html';
        }        
    }
    ...
    public function auto()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'biz/weixin/auto.html';
        }        
    }
