...
class Ctl_Biz_Shop_Verify extends Ctl_Biz
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'biz/shop/verify/index.html';
    }
    ...
    public function dianzhu()
    {
        if($data = $this->checksubmit('data')){
            ...
            $this->pagedata['detail'] = K::M('shop/verify')->detail($this->shop_id);
            $this->tmpl = 'biz/shop/verify/dianzhu.html';
        }       
    }
    ...
    public function yyzz()
    {
        if($data = $this->checksubmit('data')){
            ...
            $this->pagedata['detail'] = K::M('shop/verify')->detail($this->shop_id);
            $this->tmpl = 'biz/shop/verify/yyzz.html';
        }       
    }
    ...
    public function canyin()
    {
        if($data = $this->checksubmit('data')){
            ...
            $this->pagedata['detail'] = K::M('shop/verify')->detail($this->shop_id);
            $this->tmpl = 'biz/shop/verify/canyin.html';
        }
    }
