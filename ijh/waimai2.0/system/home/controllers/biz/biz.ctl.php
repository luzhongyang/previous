...
class Ctl_Biz extends Ctl
{
    public function __construct(&$system)
    {
        ...
        $this->msgbox->tmpl_miniframe = "view:page/miniframe.html";
        $this->msgbox->tmpl_miniload = "view:page/miniload.html";
        ...
        if($this->auth->token()){
            ...
            if($this->shop['audit'] !=1) {
                $this->msgbox->add("商户没有通过审核！");
                $this->msgbox->set_data("forward", $this->mklink("biz/account/login"));
