...
class Index extends kernel
{
    ...
    protected function _init()
    {
        ...
        if(!in_array($CLIENT_API, array('CUSTOM', 'BIZ', 'STAFF'))){
            $CLIENT_API = 'CUSTOM';
        }
    ...
    protected function _route($uri=null)
    {
        ...
        $app_lang_file = __CORE_DIR.'lang'.DIRECTORY_SEPARATOR.__LANG.DIRECTORY_SEPARATOR.'api.php';
