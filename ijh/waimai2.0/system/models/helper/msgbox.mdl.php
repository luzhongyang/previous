...
class Mdl_Helper_MsgBox
{
    ...
    public $tmpl_miniload = null;
    public $tmpl_miniframe = null;
    ...
    public function miniload($url='', $timer=3)
    {
        ...
        }else if($this->tmpl_miniload){
            $output->display($this->tmpl_miniload);
        }else{
    ...
    public function miniframe($url='', $timer=3)
    {
        ...
        }else if($this->tmpl_miniframe){
            $output->setTemplateDir(__TPL_DIR.'default');
            $output->display($this->tmpl_miniframe);
        }else{
