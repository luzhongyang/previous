...
class Ctl_Pintuan_Product extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'admin:pintuan/product/items.html';
    }

    public function so()
    {
        $this->tmpl = 'admin:pintuan/product/so.html';
    }

    public function detail($pintuan_product_id = null)
    {
        if(!$pintuan_product_id = (int) $pintuan_product_id){
            ...
            $view_params = K::M('pintuan/product')->view_params;
            $detail['tuan_type'] = $view_params['tuan_type']['select'][$detail['tuan_type']];
            $detail['tuan_limit'] = $view_params['tuan_limit']['select'][$detail['tuan_limit']];
            $detail['master_is_free'] = $view_params['master_is_free']['select'][$detail['master_is_free']];
            $detail['master_need_buy'] = $view_params['master_need_buy']['select'][$detail['master_need_buy']];
            $detail['address_type'] = $view_params['address_type']['select'][$detail['address_type']];
            $detail['closed'] = $view_params['closed']['select'][$detail['closed']];
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'admin:pintuan/product/detail.html';
        }
    }
