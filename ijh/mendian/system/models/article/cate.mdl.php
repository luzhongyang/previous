...
{   
    ...
    protected $_cols = 'cate_id,parent_id,title,level,from,seo_title,seo_keywords,seo_description,orderby,hidden,dateline';
    protected $_orderby = array('parent_id'=>'ASC','orderby'=>'ASC','cate_id'=>'ASC');
    ...
    public function fetch_all()
    {
        if($this->_pre_cache_key === null){
            ...
            $sql = "SELECT * FROM ".$this->table($this->_table)." ORDER BY level ASC,orderby ASC,cate_id ASC";
    ...
    public function childrens($cate_id)
    {
        if(!$cate_id = (int)$cate_id){
            return false;
        }
    ...
    protected function _check($data, $cid=null)
    {
        ...
        unset($data['cate_id'], $data['dateline']);
