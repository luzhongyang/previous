...
class Ctl_Ucenter_Addr extends Ctl_Ucenter
{
    ...
    public function index($shop_id)
    {
        ...
        $this->tmpl = 'weidian/ucenter/addr/index.html';
    }
    ...
    public function create($from, $cate_id)
    {
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'weidian/ucenter/addr/create.html';
        }
    }
    ...
    public function edit($addr_id)
    {
        if(!$addr_id){
            ...
            $this->tmpl = "weidian/ucenter/addr/edit.html";
        }
    }
    ...
    public function map()
    {
        $this->tmpl = 'weidian/ucenter/addr/map.html';
    }
