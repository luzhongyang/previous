...
class Ctl_Cashier_Productcate extends Ctl_Cashier_Cashier
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'biz/cashier/productcate/index.html';
    }
    ...
    public function create()
    {
        if($data = $this->checksubmit('data')){
            ...
            if($cate_id = K::M('cashier/product/cate')->create($data)){
                ...
                $this->msgbox->set_data('forward', '?biz/cashier/productcate-index.html');
            } 
            
        }else{
            $this->tmpl = 'biz/cashier/productcate/create.html';
        }
    }
    ...
    public function edit($cate_id=null)
    {
        if(!($cate_id = (int)$cate_id) && !($cate_id = $this->GP('cate_id'))){
        ...
        }else if(false && $detail['shop_id'] != $this->shop_id){
            ...
            $this->tmpl = 'biz/cashier/productcate/edit.html';
        }
    }
