...
class WebtplController extends CommonController{	
	// 显示模板管理
	public function index(){
		...
		$_SESSION['tpl_jumpurl'] = 'Webtpl/index/id/'.url_repalce($dirpath,'desc');
		if($dirlast && $dirlast != '.'){
	...
	public function update(){
		...
		$this->success('恭喜您，模板更新成功！',U('Webtpl/index'));
	}
	// 删除模板
	public function del(){
		...
		@unlink($file);
		$this->success('删除文件成功！',U('Webtpl/index'));
	}				
}
