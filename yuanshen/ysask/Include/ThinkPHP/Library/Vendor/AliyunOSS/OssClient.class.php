...
use Vendor\AliyunOSS\Core\MimeTypes;
use Vendor\AliyunOSS\Core\OssException;
use Vendor\AliyunOSS\Http\RequestCore;
use Vendor\AliyunOSS\Http\RequestCore_Exception;
use Vendor\AliyunOSS\Http\ResponseCore;
use Vendor\AliyunOSS\Model\CorsConfig;
use Vendor\AliyunOSS\Model\CnameConfig;
use Vendor\AliyunOSS\Model\LoggingConfig;
use Vendor\AliyunOSS\Model\LiveChannelConfig;
use Vendor\AliyunOSS\Model\LiveChannelInfo;
use Vendor\AliyunOSS\Model\LiveChannelListInfo;
use Vendor\AliyunOSS\Result\AclResult;
use Vendor\AliyunOSS\Result\BodyResult;
use Vendor\AliyunOSS\Result\GetCorsResult;
use Vendor\AliyunOSS\Result\GetLifecycleResult;
use Vendor\AliyunOSS\Result\GetLoggingResult;
use Vendor\AliyunOSS\Result\GetRefererResult;
use Vendor\AliyunOSS\Result\GetWebsiteResult;
use Vendor\AliyunOSS\Result\GetCnameResult;
use Vendor\AliyunOSS\Result\HeaderResult;
use Vendor\AliyunOSS\Result\InitiateMultipartUploadResult;
use Vendor\AliyunOSS\Result\ListBucketsResult;
use Vendor\AliyunOSS\Result\ListMultipartUploadResult;
use Vendor\AliyunOSS\Model\ListMultipartUploadInfo;
use Vendor\AliyunOSS\Result\ListObjectsResult;
use Vendor\AliyunOSS\Result\ListPartsResult;
use Vendor\AliyunOSS\Result\PutSetDeleteResult;
use Vendor\AliyunOSS\Result\DeleteObjectsResult;
use Vendor\AliyunOSS\Result\CopyObjectResult;
use Vendor\AliyunOSS\Result\CallbackResult;
use Vendor\AliyunOSS\Result\ExistResult;
use Vendor\AliyunOSS\Result\PutLiveChannelResult;
use Vendor\AliyunOSS\Result\GetLiveChannelHistoryResult;
use Vendor\AliyunOSS\Result\GetLiveChannelInfoResult;
use Vendor\AliyunOSS\Result\GetLiveChannelStatusResult;
use Vendor\AliyunOSS\Result\ListLiveChannelResult;
use Vendor\AliyunOSS\Result\AppendResult;
use Vendor\AliyunOSS\Model\ObjectListInfo;
use Vendor\AliyunOSS\Result\UploadPartResult;
use Vendor\AliyunOSS\Model\BucketListInfo;
use Vendor\AliyunOSS\Model\LifecycleConfig;
use Vendor\AliyunOSS\Model\RefererConfig;
use Vendor\AliyunOSS\Model\WebsiteConfig;
use Vendor\AliyunOSS\Core\OssUtil;
use Vendor\AliyunOSS\Model\ListPartsInfo;
