...
class Geetestlib {
    ...
    /** 综合验证 */
    public function validate($challenge, $validate, $seccode, $server_status = 1)
    {
        return $server_status == 1 ?
            $this->success_validate($challenge, $validate, $seccode) :
            $this->fail_validate($challenge, $validate, $seccode);
    }
