...
INSERT INTO `ask_category` (`id`, `name`, `dir`, `pid`, `grade`, `displayorder`, `questions`, `alias`, `miaosu`, `followers`, `image`) VALUES
(1, '默认分类', 'default', 0, 1, 0, 17, '默认分类别名', '创作知乎方式的交流，感受生活的乐趣111', 0, ''),
(2, '电脑/网络', '', 0, 1, 2, 166, '', '电脑相关介绍', 2, ''),
(3, '手机/数码', '', 0, 1, 3, 44, '', '手机数码相关交流，提供不一样的方式', 0, ''),
...
CREATE TABLE IF NOT EXISTS `ask_diaodan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `huiyuanzhanghao` varchar(200) NOT NULL,
  `leixing` varchar(200) NOT NULL,
  `shijian` varchar(200) NOT NULL,
  `jine` varchar(200) NOT NULL,
  `zhuanzhangpingtai` varchar(200) NOT NULL,
  `caozuowangzhi` varchar(200) NOT NULL,
  `cunkuanfangshi` varchar(200) NOT NULL,
  `dingdanhao` varchar(200) NOT NULL,
  `zhuangtai` varchar(200) NOT NULL,
  `beizhu` varchar(200) NOT NULL,
  `caozuoren` varchar(200) NOT NULL,
  `shi` int(10) NOT NULL,
  `fen` int(10) NOT NULL,
  `miao` int(10) NOT NULL,
  `caozuoriqi` varchar(200) NOT NULL,
  `shanghumingchen` varchar(200) NOT NULL,
  `cunkuangjietu` varchar(200) NOT NULL,
  `chulirenid` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `ask_diaodan` (`id`, `huiyuanzhanghao`, `leixing`, `shijian`, `jine`, `zhuanzhangpingtai`, `caozuowangzhi`, `cunkuanfangshi`, `dingdanhao`, `zhuangtai`, `beizhu`, `caozuoren`, `shi`, `fen`, `miao`, `caozuoriqi`, `shanghumingchen`, `cunkuangjietu`, `chulirenid`) VALUES
(15, 'xiaomi', '存款掉单', '八点之前', '11', 'B>B', 'www.baidu.com', 'ATM转账', '201507149845', '未处理', '', '1', 21, 3, 13, '2016-01-30', '小米', 'http://www.ask2.cn//data/tmp/user_avatar_1454158993.jpg', 0),
(16, 'xiaobao', '转账掉单', '八点二十', '66', 'C>A', 'www.zhengyingkeji.com', '支付宝转账', '2015407149845', '未处理', '', '1', 21, 3, 59, '2016-01-30', '宝宝', 'http://www.ask2.cn//data/tmp/user_avatar_1454159039.jpg', 0),
(17, 'afeng', '转账掉单', '12:33', '33', 'AG>PT', 'www.zhengyingkeji.com', '银行支付', '2015407149845', '未处理', '', '1', 21, 4, 42, '2016-01-29', '阿峰', 'http://www.ask2.cn//data/tmp/user_avatar_1454159082.jpg', 0),
(18, 'ajssk2', '存款掉单', '15点多', '502', 'BBIN>TTGS', 'hvjjs.com', '易宝支付', '2051465821535', '未处理', '', '1', 21, 10, 52, '2016-01-30', '华美', 'http://www.ask2.cn//data/tmp/user_avatar_1454159452.gif', 0),
(20, 'a1325915858', '转账掉单', '22:10', '100', '主账号>PT', 'www.hv822.com', '易宝支付', '', '未处理', '', '312', 22, 15, 37, '2016-01-30', '', '', 0),
(21, 'xiao123', '转账掉单', '2016.1.30', '10000', '主账号>PT', 'www.800.com', '易宝支付', '', '未处理', '', '313', 22, 16, 0, '2016-01-30', '', '', 0),
(22, 'dsfew323423', '转账掉单', '23:44', '1333', 'PT>TTGS', 'www.hv811.com', '易宝支付', '', '未处理', '', '316', 22, 16, 8, '2016-01-30', '', '', 0),
(23, 'lx3106115200', '转账掉单', '22点15', '1200', '主账号>PT', 'www.hv811.com', '易宝支付', '', '未处理', '', '315', 22, 18, 34, '2016-01-30', '', '', 0),
(24, 'fenvbks2', '存款掉单', '16:27', '588', 'PT>PT', '', '支付宝转账', '2012512548', '未处理', '', '1', 22, 19, 37, '2016-01-30', '华美', '', 0),
(25, 'qiang87', '转账掉单', '2016年1月10号11点50', '150', '主账号>PT', 'www.hv811.com', '易宝支付', '', '未处理', '', '314', 22, 20, 53, '2016-01-30', '主账户转账PT ', '', 0),
(26, 'abc569', '转账掉单', '   20:39 ', '  600   ', '主账号>BBIN', 'www.hv800.com', '易宝支付', '', '未处理', '', '319', 22, 21, 53, '2016-01-30', '', '', 0),
(27, 'qiang87', '存款掉单', '11点', '50', 'N2>N2', 'www.hv811.com', '易宝支付', '2901248134kg124sj', '未处理', '', '314', 22, 34, 45, '2016-01-30', '魅力', '', 0),
(28, 'kjwoifshw', '转账掉单', '22:51', '625', '主账号>TTGS', 'hviw.com', '易宝支付', '', '已补', '', '1', 22, 34, 56, '2016-01-30', '', '', 322),
(29, 'yuki', '转账掉单', '22:49', '200', '主账号>PT', 'www.hv599.com', '银行支付', '', '已补', '', '325', 23, 2, 38, '2016-01-30', '', '', 322),
(30, 'HH12345', '转账掉单', '23:00', '50', '主账号>EA', 'www.hv800.com', '易宝支付', '', '已补', '', '329', 23, 7, 57, '2016-01-30', '', '', 322),
(31, 'cs0000', '转账掉单', '0点28', '100', '主账号>PT', 'www.hv811.com', '易宝支付', '', '未掉单', '没有存款', '327', 0, 31, 13, '2016-01-31', '', '', 322),
(32, 'wangming123       ', '转账掉单', '2016-1-31    01:00', '50', '主账号>PT', 'www.hv599.com', '易宝支付', '', '已补', '', '331', 1, 13, 25, '2016-01-31', '', '', 322),
(33, 'CFX1982', '转账掉单', '3:10', '3000', '主账号>PT', 'http://www.hv811.com/#member/message', '易宝支付', '', '已补', '', '330', 3, 15, 55, '2016-01-31', '', '', 322),
(34, 'wangming12', '存款掉单', '02.3', '100', 'N2>N2', '', '易宝支付', '', '已补', '', '322', 8, 0, 37, '2016-01-31', '第三方', '', 322),
(35, 'zx7700    ', '转账掉单', '10:25', '48', '主账号>PT', 'http://kf1.learnsaas.com:8080/chat/preview.jsp', '易宝支付', '', '未掉单', '处理完毕', '337', 10, 33, 55, '2016-01-31', '', '', 1),
(36, 'xiaomi', '存款掉单', '八点之前', '11', 'PT>N2', 'www.baidu.com', '易宝支付', '201507149845', '已补', '', '1', 12, 3, 11, '2016-01-31', '小米', 'http://www.ask2.cn//data/tmp/user_avatar_1454212991.jpg', 322),
(37, 'adsfaf47474', '存款掉单', '22:45', '6322', '主账号>N2', 'lv.com', 'ATM存款', '248121534515343514', '已补', '已经处理完毕!', '1', 14, 46, 20, '2016-01-31', '支付宝转招行', '', 1),
(38, 'xiaomi', '存款掉单', '八点之前', '33', 'N2>主账号', 'www.zhengyingkeji.com', 'ATM存款', '201507149845', '已补', '', '1', 21, 21, 58, '2016-01-31', '小米', 'http://www.ask2.cn//data/tmp/user_avatar_1454246518.jpg', 322),
(39, 'qz900511', '存款掉单', '01-31 23:51', '200', 'N2>N2', '易宝', '易宝支付', '2923639116160131', '无掉单', '没有支付成功', '319', 12, 44, 22, '2016-02-01', '雪莉米娜', '', 323),
(40, 'wmy2555956', '转账掉单', '2016年2月1号 23点49分', '100', '主账号>PT', 'hv888.com', '易宝支付', '', '已补', '', '325', 0, 25, 46, '2016-02-02', '', '', 322),
(41, 'yangyang666 ', '转账掉单', '2:21', '2000', '主账号>PT', 'hv889', '易宝支付', '', '未处理', '', '335', 2, 26, 23, '2016-02-05', '', '', 0),
(42, 'caisongsu   ', '转账掉单', ' 13点06分', '2200', 'EA>主账号', 'www.hv500.com', '易宝支付', '', '未处理', '', '321', 13, 22, 57, '2016-02-06', '', '', 0),
(43, 'W1597840', '转账掉单', '４：５０分左右', '3000', '主账号>AG', 'hv811', '易宝支付', '', '未处理', '', '335', 5, 43, 30, '2016-02-09', '', '', 0),
(44, 'kingmanmax', '转账掉单', '0:30左右', '58', 'N2>PT', 'hv128.com', '易宝支付', '', '未处理', '', '0', 1, 3, 22, '2016-02-10', '', '', 0),
(45, 'a119988', '转账掉单', '00.08', '100', '主账号>PT', 'm.hvbet618.com ', '易宝支付', '', '未处理', '', '0', 1, 8, 36, '2016-02-10', '', '', 0),
(46, 'CHANGZIWEI', '转账掉单', '12点半', '300 ', '主账号>PT', 'hv500', '易宝支付', '', '未处理', '', '0', 1, 10, 21, '2016-02-10', '', '', 0),
(47, 'yanyan0619   ', '转账掉单', '12.30左右', '50 ', '主账号>PT', 'm.hvbet618.com ', '易宝支付', '', '未处理', '', '0', 1, 12, 48, '2016-02-10', '', '', 0),
(48, 'yanyan0619   ', '转账掉单', '12.30左右', '50 ', '主账号>PT', 'm.hvbet618.com ', '易宝支付', '', '未处理', '', '0', 1, 13, 31, '2016-02-10', '', '', 0),
(49, 'awuxiaoyang', '转账掉单', '00.56', '100 ', '主账号>PT', 'm.hvbet618.com ', '易宝支付', '', '未处理', '', '0', 1, 13, 59, '2016-02-10', '', '', 0),
(50, 'shen555   ', '转账掉单', ' 00.35,35', '50', '主账号>PT', 'm.hvbet618.com ', '易宝支付', '', '未处理', '', '0', 1, 15, 36, '2016-02-10', '', '', 0),
(51, 'zy1118', '转账掉单', '01：16', '40', '主账号>PT', 'm.hvbet618.com ', '易宝支付', '', '未处理', '', '0', 1, 18, 18, '2016-02-10', '', '', 0),
(52, 'xlshan819', '转账掉单', ' 1:03:45', '144', '主账号>PT', 'www.hongyun666.com', '易宝支付', '', '未处理', '', '0', 1, 39, 55, '2016-02-10', '', '', 0),
(53, 'shen555     ', '转账掉单', '00 36 ', '50', '主账号>PT', 'www.hv899.com', '易宝支付', '', '未处理', '', '0', 1, 51, 7, '2016-02-10', '', '', 0),
(54, 'yuhang199106', '转账掉单', '1:15左右', '300', '主账号>PT', 'hv168', '易宝支付', '', '未处理', '', '344', 1, 51, 34, '2016-02-10', '', '', 0),
(55, 'kobebryant', '转账掉单', '1.10', '140', '主账号>PT', 'hv844', '易宝支付', '', '未处理', '', '344', 1, 53, 46, '2016-02-10', '', '', 0),
(56, 'a18039172555', '转账掉单', '时间1点左右', '80', '主账号>PT', '手机版网址', '易宝支付', '', '未处理', '', '344', 1, 54, 29, '2016-02-10', '', '', 0),
(57, 'kiss8216            ', '转账掉单', '01:38', '102  ', '主账号>PT', 'hv522.com', '易宝支付', '', '未处理', '', '0', 1, 55, 44, '2016-02-10', '', '', 0),
(58, 'a18679268765', '转账掉单', '12点46左右 ', '100', '主账号>PT', 'hv00', '易宝支付', '', '未处理', '', '344', 1, 56, 4, '2016-02-10', '', '', 0),
(59, 'l29105', '转账掉单', '1:14', '10', '主账号>PT', 'hv218', '易宝支付', '', '未处理', '', '344', 1, 56, 50, '2016-02-10', '', '', 0),
(60, 'zheng3320', '转账掉单', '1:02', '20', '主账号>PT', 'www.hv188com', '易宝支付', '', '未处理', '', '0', 1, 57, 8, '2016-02-10', '', '', 0),
(61, 'q1192178921', '转账掉单', '1点13分', '800', '主账号>PT', 'hv500', '易宝支付', '', '未处理', '', '344', 1, 57, 42, '2016-02-10', '', '', 0),
(62, 'dingyongjie', '转账掉单', ' 00:29', '500', '主账号>PT', '手机版网址', '易宝支付', '', '未处理', '', '344', 1, 58, 26, '2016-02-10', '', '', 0),
(63, 'kobebryant ', '转账掉单', '1.10 ', '140元', '主账号>PT', 'hv844', '易宝支付', '', '未处理', '', '344', 1, 59, 8, '2016-02-10', '', '', 0),
(64, 'czy510310   ', '转账掉单', '1:02', '400', '主账号>PT', 'www.hv522.com', '易宝支付', '', '未处理', '', '0', 2, 23, 25, '2016-02-10', '', '', 0),
(65, 'shen555', '存款掉单', '2016/2/10 0:35:35 ', '50元 ', 'N2>N2', 'hv899', '易宝支付', '2927836425160210', '未处理', '', '344', 2, 35, 43, '2016-02-10', '易宝', '', 0),
(66, 'shen555', '转账掉单', '2016-2-10 0:36:27', '50元', '主账号>PT', '.hv899.', '易宝支付', '', '未处理', '', '344', 2, 43, 18, '2016-02-10', '', '', 0),
(67, 'jinggang8888', '转账掉单', '1:05左右', '399', '主账号>PT', 'hv544', '易宝支付', '', '未处理', '', '0', 2, 47, 3, '2016-02-10', '', '', 0),
(68, 'jinggang8888', '转账掉单', '1:05左右', '399', '主账号>PT', 'hv544', '易宝支付', '', '未处理', '', '0', 2, 47, 22, '2016-02-10', '', '', 0),
(69, 'a18688050200', '转账掉单', '1:02左右', '100 ', '主账号>PT', 'www.hv00.com', '易宝支付', '', '已补', 'ffdfsdfd', '0', 3, 5, 50, '2016-02-10', '', '', 1),
(70, 'qq19860624  ', '转账掉单', '16:52', '59元', '主账号>PT', 'www.hv168.com ', '易宝支付', '', '已补', 'fffff', '0', 20, 42, 23, '2016-02-17', '', '', 1),
(71, 'rerewr', '存款掉单', '22:33', '33', '主账号>N2', 'www.baidu.com', '易宝支付', '', '无掉单', '44343', '1', 11, 20, 22, '2016-02-29', '4rdwr', '', 1);

-- --------------------------------------------------------

--
-- 表的结构 `ask_diaodancunkuan`
--

CREATE TABLE IF NOT EXISTS `ask_diaodancunkuan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `ask_diaodancunkuan`
--

INSERT INTO `ask_diaodancunkuan` (`id`, `name`) VALUES
(12, '易宝支付'),
(9, 'ATM存款'),
(10, '银行支付'),
(11, '支付宝转账'),
...
--
-- 表的结构 `ask_diaodanpingtai`
--

CREATE TABLE IF NOT EXISTS `ask_diaodanpingtai` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- 转存表中的数据 `ask_diaodanpingtai`
--

INSERT INTO `ask_diaodanpingtai` (`id`, `name`) VALUES
(22, 'N2'),
(15, 'PT'),
(16, 'AG'),
(17, '主账号'),
...
--
-- 转存表中的数据 `ask_news_class`
--

INSERT INTO `ask_news_class` (`id`, `name`, `alias`, `description`, `parent`, `count`, `seoname`, `time`, `dept`) VALUES
(1, '默认分类', 'default', '默认分类描述', 0, 0, '默认分类', 1481454191, 1),
(12, '情感', 'mood', '情感家庭倾诉', 0, 0, '', 1481454191, 1),
(13, '编程', 'code', '程序员编程开发', 0, 0, '编程开发', 1481454475, 1),
(14, 'php开发', 'php', '在线学习php，php交流', 13, 0, 'php开发学习_php开发教程', 1481454636, 2),
(15, 'thinkphp开发', 'thinkphp', 'thinkphp框架在线学习', 14, 0, 'thinkphp框架学习', 1481454686, 3);
...
--
-- 转存表中的数据 `ask_user_depositmoney`
--

INSERT INTO `ask_user_depositmoney` (`id`, `needpay`, `type`, `typeid`, `fromuid`, `state`, `touid`, `time`) VALUES
(7, 2, 'eqid', 415, 29, 0, 1, 1487414968),
(8, 4, 'qid', 415, 29, 0, 0, 1487414968),
(10, 1, 'qid', 416, 29, 0, 0, 1487415338);
...
--
-- 转存表中的数据 `ask_weixin_setting`
--

INSERT INTO `ask_weixin_setting` (`id`, `wxname`, `wxid`, `weixin`, `appid`, `appsecret`, `winxintype`) VALUES
(7, '技术达人', 'gh_aca4f7676e33', 'fansns', 'wx399655b19624f908', '730795c87522229f75545a224371a096', '2');
