...
</div><? if(isset($message)) { $type=isset($type)?$type:'correctmsg';  ?><div class="alert alert-success"><?=$message?></div><? } ?><table class="table">
...
<td class="altbg2">
<input class="radio inline"  type="radio"  <? if(1==$setting['ucenter_open'] ) { ?>checked<? } ?>  value="1" name="ucenter_open" ><label for="yes">开启</label>&nbsp;&nbsp;
<input class="radio inline"  type="radio"  <? if(0==$setting['ucenter_open'] ) { ?>checked<? } ?> value="0" name="ucenter_open" ><label for="no">关闭</label>
</td>
</tr>
<tr>
