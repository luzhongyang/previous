            ...
            if(temps.length>0){
                ...
                for(var tp=0;tp<temps.length;tp++){
                    if(temps[tp]!=''){
                        ...
                        var  lifile="<li class='urlcollect hand' >val</li>";
                ...
                $(".tpldir li:first-child").addClass("colorbg");

                gettplist($(".tpldir li:first-child").html());
                $(".urlcollect").click(function() {

                    $(".tpldir li").removeClass("colorbg");
