...
<h4 class="title">
  <div class="normal-title">
    <a class="active" href="http://www.ask2test.com/?user/login.html">登录</a>
    <b>·</b>
    <a id="js-sign-up-btn" class="" href="http://www.ask2test.com/?user/register.html">注册</a>
  </div>
</h4>
 ...
 <input type="hidden" id="usersid" name="usersid" value='<?=$_SESSION["userid"]?>'/>
  <input type="hidden" id="apikey" name="apikey" value='<?=$_SESSION["apikey"]?>'/>
    ...
    <div class="forget-btn">
      <a class=""  href="http://www.ask2test.com/?user/getpass.html">登录遇到问题?</a>
