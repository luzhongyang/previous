         ...
         <tr>
            ...
            <td class="altbg2">
              <select name="bianma" id="bianma">
               <option value ="utf-8" <? if($bianma==utf-8) { ?> selected  <? } ?>>utf-8</option>
  <option value ="gb2312" <? if($bianma==gb2312) { ?> selected  <? } ?>>gb2312</option>
     ...
     <option value="30">30</option>
       <option value="40">40</option>
        ...
        <tr>
            ...
            <td class="altbg2">
               <input type="text"  id="caiji_url" value="<?=$caiji_url?>" class="form-control"  name="caiji_url" style="width:300px" />
            </td>
        </tr>
        <tr>
       ...
       <tr>
            ...
            <td class="altbg2">
               <input type="text" value="<?=$caiji_prefix?>" class="form-control short-input"   id="caiji_prefix" name="caiji_prefix" style="width:300px"  />
           <br>   <input type="checkbox"  <? if($ckbox!=null) { ?> checked  <? } ?> id="ckbox" name="ckbox" >  <label>a标签title中获取标题(如果标题带有省略号请勾选)</label>
            </td>
        </tr>
...
<? if(is_array($userlist)) { foreach($userlist as $activeuser) { ?>
  ...
  <option value ="<?=$activeuser['uid']?>" <? if($s_username==$activeuser['uid']) { ?> selected  <? } ?>> <?=$activeuser['username']?></option>
...
<? } } ?>
           ...
           <tr>
            ...
            <td class="altbg2">
               <input type="text"  id="caiji_daan" class="form-control short-input"  value="<?=$caiji_daan?>" name="caiji_daan" style="width:300px" />
            </td>
        </tr>
         <tr>
            <td class="altbg1" width="45%"><b>问题描述:</b><br>填写描述html标签的类名或者ID即可，记得类名加".",ID加"#"</td>
            <td class="altbg2">
               <input type="text"  id="caiji_desc" class="form-control short-input"  value="<?=$caiji_desc?>" name="caiji_desc" style="width:300px" />
            </td>
        </tr>
         <tr>
            <td class="altbg1" width="45%"><b>最佳答案规则:</b><br>填写描述html标签的类名或者ID即可，记得类名加".",ID加"#"</td>
            <td class="altbg2">
               <input type="text"  id="caiji_best" class="form-control short-input"  value="<?=$caiji_best?>" name="caiji_best" style="width:300px" />
            </td>
        </tr>
         <tr>
            <td class="altbg1" width="45%"><b>回答用户名采集规则:</b><br>填写描述用户名所在html标签的类名或者ID即可，记得类名加".",ID加"#"</td>
            <td class="altbg2">
               <input type="text"  id="caiji_hdusername" class="form-control short-input"  value="<?=$caiji_hdusername?>" name="caiji_hdusername" style="width:300px" />
            </td>
        </tr>
         <tr>
            <td class="altbg1" width="45%"><b>回答用户头像采集规则:</b><br>填写用户头像html标签的类名或者ID即可，记得类名加".",ID加"#"</td>
            <td class="altbg2">
               <input type="text"  id="caiji_hdusertx"  class="form-control short-input"  value="<?=$caiji_hdusertx?>" name="caiji_hdusertx" style="width:300px" />
            </td>
        </tr>
        <tr>
            <td class="altbg1" width="45%"><b>答案采集网站域名:</b><br>如果问题网址不是绝对路径请填写</td>
            <td class="altbg2">
               <input type="text"  id="caiji_yuming" class="form-control short-input"  value="<?=$caiji_yuming?>" name="caiji_yuming" style="width:300px" />
            </td>
        </tr>
           <tr>
...
</form><? if(isset($message)) { $type=isset($type)?$type:'correctmsg';  ?><table class="table alert alert-info">
    <tr>
        <td class="<?=$type?>"><?=$message?></td>
    </tr>
</table><? } ?><div style="width:100%; height:15px;color:#000;margin:0px 0px 10px;">
...
<? if(is_array($caijilist)) { foreach($caijilist as $caijidata) { ?>
