...
<? if(is_array($topiclist)) { foreach($topiclist as $nindex => $topic) { ?>
                       <li ><a  class="li-a-title" target="_blank" href="http://www.ask2test.com/?article-<?=$topic['id']?>.html" title="<?=$topic['title']?>"><?=$topic['title']?></a></li>
                       
<? } } ?>
      </ul>
       <a href="http://www.ask2test.com/?topic/hotlist.html" target="_blank" class="find-more">
