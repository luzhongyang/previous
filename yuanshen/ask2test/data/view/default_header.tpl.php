...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="width-limit">
        ...
        <!-- 右上角 -->
         ...
         <a class="btn write-btn" target="_blank" href="http://www.ask2test.com/?question/add.html">
        <i class="fa fa-magic"></i>来提问
</a>      
        <a class="btn write-btn" target="_blank" href="http://www.ask2test.com/?user/addxinzhi.html">
            <i class="fa fa-pencil"></i>写文章
        </a>
        <!-- 如果用户登录，显示下拉菜单 -->
        <div class="user">
            <div data-hover="dropdown">
                <a class="avatar" href="http://www.ask2test.com/?user/default.html"><img src="<?=$user['avatar']?>" alt="120" /></a>
            </div>
            <ul class="dropdown-menu">
                ...
                <li>
                    <a href="http://www.ask2test.com/?user/default.html">
                        <i class="fa fa-user"></i><span>我的主页</span>
                    </a>          </li>
             
                <li>
                    <a href="http://www.ask2test.com/?ut-<?=$user['uid']?>.html}">
                        <i class="fa fa-rss-square"></i><span>我的文章</span>
                    </a>          </li>
                <li>
                    <a href="http://www.ask2test.com/?user/userbank.html">
                        <i class="fa fa-credit-card"></i><span>我的钱包</span>
                    </a>          </li>
                <li>
                    <a href="http://www.ask2test.com/?user/attention/question.html">
                        <i class="fa fa-star"></i><span>我的收藏</span>
                    </a>          </li>
                <li>
                    <a href="http://www.ask2test.com/?user/ask/1.html">
                        <i class="fa fa-question-circle-o"></i><span>我的问题</span>
                    </a>          </li>
                <li>
                    <a rel="nofollow" data-method="delete" href="http://www.ask2test.com/?user/logout.html">
  ...
  <? } else { ?>           <!-- 未登录显示登录/注册/写文章/提问题 -->
      ...
      <a class="btn write-btn" target="_blank" href="http://www.ask2test.com/?user/addxinzhi.html">
        <i class="fa fa-pencil"></i>写文章
</a>      <a class="btn sign-up" href="http://www.ask2test.com/?user/register.html">注册</a>
      <a class="btn log-in" href="http://www.ask2test.com/?user/login.html">登录</a>
            ...
            <div class="collapse navbar-collapse" id="menu">
             <ul class="nav navbar-nav">
                     ...
                     <? if(0!=$user['uid']) { ?>                           <li class="active">
                        ...
                        <li >
              <a class="app-download-btn" href="http://www.ask2test.com/?user/activelist.html"><span class="menu-text">作者</span><i class="fa fa-lemon-o menu-icon"></i></a>
            </li>
                      <li >
              <a class="app-download-btn" href="http://www.ask2test.com/?expert.html"><span class="menu-text">专家</span><i class="fa fa-user-circle-o menu-icon"></i></a>
            </li>
               <li >
              <a class="app-download-btn" href="http://www.ask2test.com/?note/list.html"><span class="menu-text">公告</span><i class="fa fa-bullhorn menu-icon"></i></a>
            </li>
                    ...
                    <a href="http://www.ask2test.com/?message/system.html">
...
<li >
            ...
            <li >
              <a class="app-download-btn" href="http://www.ask2test.com/?note/list.html"><span class="menu-text">公告</span><i class="fa fa-bullhorn menu-icon"></i></a>
                             ...
                             <? } ?>              
                    <li class="search">
                        <form target="_blank"  name="searchform" action="http://www.ask2test.com/?question/search.html" method="post" accept-charset="UTF-8" >
