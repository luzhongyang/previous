...
<? if(is_array($doinglist)) { foreach($doinglist as $index => $question) { ?>
    ...
    <? if($question['image']!=null) { ?>  
      <a class="wrap-img" href="<?=$question['url']?>" target="_blank">
        ...
        <a class="avatar" target="_blank" href="http://www.ask2test.com/?u-<?=$question['authorid']?>.html">
                    <img src="<?=$question['avatar']?>" alt="96">
                </a>      <div class="name">
                <a class="blue-link" target="_blank" href="http://www.ask2test.com/?u-<?=$question['authorid']?>.html"><?=$question['author']?><?=$question['actiondesc']?></a>
