...
<? if(is_array($userarticle)) { foreach($userarticle as $index => $uarticle) { ?>
        <li>
        <a href="http://www.ask2test.com/?u-<?=$uarticle['uid']?>.html" target="_blank" class="avatar">
  ...
  <? } ?>  
        ...
        <a href="http://www.ask2test.com/?u-<?=$uarticle['uid']?>.html" target="_blank" class="name">
            <?=$uarticle['username']?>
        </a>
         <p>
...
<? } } ?>
         ...
         <a href="http://www.ask2test.com/?user/activelist.html" target="_blank" class="find-more">
