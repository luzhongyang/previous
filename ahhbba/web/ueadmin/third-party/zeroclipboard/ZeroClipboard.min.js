...
!function(a) {
    ...
    var b, c = {bridge: null, version: "0.0.0", pluginType: "unknown", disabled: null, outdated: null, unavailable: null, deactivated: null, overdue: null, ready: null}, d = {}, e = null, f = 0, g = {}, h = 0, i = {}, j = function() {
        ...
        for (var d in a)
            if (a.hasOwnProperty(d)) {
                ...
                var e = a[d];
                for (var f in e)
                    f && e.hasOwnProperty(f) && b.hasOwnProperty(f) && (c[d][b[f]] = e[f])
            }
        return c
    }, J = function(a) {
        return function(b) {
        ...
        if (navigator.plugins && navigator.plugins.length)
            e = navigator.plugins["Shockwave Flash"], d(e), navigator.plugins["Shockwave Flash 2.0"] && (h = !0, k = "2.0.0.11");
    ...
    L.isFlashUnusable = function() {
        ...
        "object" == typeof a && null !== a && z(O, a);
        {
            if ("string" != typeof a || !a) {
                var b = {};
                for (var c in O)
                    O.hasOwnProperty(c) && (b[c] = "object" == typeof O[c] && null !== O[c] ? "length"in O[c] ? O[c].slice(0) : z({}, O[c]) : O[c]);
                return b
            }
        ...
        for (var e in c)
            e && c.hasOwnProperty(e) && "string" == typeof c[e] && c[e] && (d[e] = c[e])
    ...
    L.emit = function(b) {
        ...
        if ("string" == typeof b && b && (f = b), "object" == typeof b && b && "string" == typeof b.type && b.type && (f = b.type, g = b), f) {
            ...
            if (h = !/^(before)?copy$/.test(b.type), b.client)
                ...
                for (i = b.target && b.target !== a && O.autoActivate === !0?Z(b.target):N(), j = 0, k = i.length; k > j; j++)
    ...
    L.prototype.on = function(a, b) {
        ...
        if ("string" == typeof a && a)
            ...
            for (d in a)
                a.hasOwnProperty(d) && "string" == typeof d && d && "function" == typeof a[d] && this.on(d, a[d]);
        if (f && f.length) {
        ...
        for (var e = a.length; e--; )
            if (a.hasOwnProperty(e) && a[e] && 1 === a[e].nodeType) {
                for (c = 0; - 1 !== (c = v(a[e], d, c)); )
                    d.splice(c, 1);
                var f = i[a[e].zcClippingId];
                if (f) {
                    for (c = 0; - 1 !== (c = v(this.id, f, c)); )
                        f.splice(c, 1);
