(function() {
    (function() {
        ...
        var f = !!window.ActiveXObject, h = {removeLastbs: function(a) {
                ...
                if (null != a)
                    if (a.length === +a.length)
                        for (var c = 0, e = a.length; c < e; c++) {
                            if (!1 === d.call(b, a[c], c, a))
                                return!1
                        }
                    else
                        for (c in a)
                            if (a.hasOwnProperty(c) && !1 === d.call(b, a[c], c, a))
                                return!1
                ...
                for (var b = 0, c, e = a.className; c = d[b++]; )
                    if (!RegExp("\\b" + c + "\\b", "i").test(e))
                        return!1;
                return b - 1 == d.length
                ...
                if (e)
                    for (; e--; )
                        if (d = c[e], a.removeEventListener)
                ...
                return function(b, c, e) {
                    var k = a(b, c);
                    if (k)
                        k.ready ? e && e() : k.funs.push(e);
                    else if (d.push({doc: b, url: c.src || c.href, funs: [e]}), !b.body) {
                        e = [];
                        for (var n in c)
                            "tag" != n && e.push(n + '="' + c[n] + '"');
                        ...
                        delete c.tag;
                        for (n in c)
                            l.setAttribute(n, c[n]);
                        l.onload = l.onreadystatechange = function() {
                            if (!this.readyState || /loaded|complete/.test(this.readyState)) {
                                k = a(b, c);
                                if (0 < k.funs.length) {
                                    k.ready = 1;
                                    for (var d; d = k.funs.pop(); )
                                        d()
                                }
                ...
                if (/\bsortEnabled\b/.test(a.className))
                    f.on(a, "click", function(a) {
                        ...
                        if (-1 != c && (b(a, c, h.tableSortCompareFn || l), !f.hasClass(a.rows[0], "firstRow"))) {
                            for (c = 1; c < a.rows.length; c++)
                                f.removeClass(a.rows[c], "firstRow");
            ...
            var d = function(a, c) {
                ...
                for (c = f.isArray(c) ?
                    ...
                    for (d = 0; d < c.length; d++)
                        if (b.tagName == c[d].toUpperCase())
                            return b;
                    b = b.parentNode
                }
                return null
            }, b = function(a, d, b) {
                for (var l = a.rows, q = [], g = "TH" === l[0].cells[0].tagName, h = 0, s = l.length; h < s; h++)
                    q[h] = l[h];
    ...
    UE.parse.register("charts", function(f) {
        function h(a) {
            ...
            for (var c = 0, d; d = a[c]; c++)
                null !== d.getAttribute("data-chart") && b.push(g(d));
            ...
            f.loadFile(document, {src: c + "/dialogs/charts/chart.config.js", tag: "script", type: "text/javascript", defer: "defer"}, function() {
                for (var a = null, b = null, c = null, d = 0, f = k.length; d < f; d++) {
                    ...
                    if (h.chartType != typeConfig.length - 1) {
                        e = g[0].slice(1);
                        p = 1;
                        for (m = void 0; m = g[p]; p++)
                            b.push({name: m[0], data: m.slice(1)});
                        c.series = b;
                        c.categories = e;
                        c.title = h.title;
                        ...
                        m = [];
                        p = 1;
                        for (e = g[0].length; p < e; p++)
                            m.push([g[0][p], g[1][p] | 0]);
    ...
    UE.parse.register("background", function(f) {
        for (var h = this.root.getElementsByTagName("p"), g, a = 0, d; d = h[a++]; )
            (g = d.getAttribute("data-background")) && d.parentNode.removeChild(d);
    ...
    UE.parse.register("list", function(f) {
        function h(b) {
            ...
            f.each(b, function(b) {
                if (b.className && /custom_/i.test(b.className)) {
                    ...
                    if ("dash" == e || "dot" == e)
                        f.pushItem(g, c + " li.list-" + a[e] + "{background-image:url(" + d.liiconpath + a[e] + ".gif)}"), f.pushItem(g, c + " ul.custom_" + e + "{list-style:none;} " + c + " ul.custom_" + e + " li{background-position:0 3px;background-repeat:no-repeat}");
                    else {
                        var h = 1;
        ...
        if (b.length || d.length)
            g.push(c + " .list-paddingleft-1{padding-left:0}"),
